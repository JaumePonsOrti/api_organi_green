...
export class RequestHelper {
  ...
  public static valiadateRequestIfIsPermited(req: Request, permisos: any[]) {
    ...
    for (let index = 0; index < permisos.length; index++) {
      ...
      if (typeof permiso.permisos_nombre_controlador !== "undefined" && request[0] == permiso.permisos_nombre_controlador) {
        returna = true;
        //console.log("request 0:", returna);
      }
      if (request[1] == permiso.permisos_nombre_funcion && returna === true || typeof request[1] == "undefined" && returna === true) {
        returna = true;
